...
in this department. So the comparison result is 'higher' since 9000 > 8333.33 obviously.
...
ELECT
    ...
    t1.department_id,
    CASE
        WHEN t1.dept_avg > t2.com_avg THEN 'higher'
        WHEN t1.dept_avg < t2.com_avg THEN 'lower'
        WHEN t1.dept_avg = t2.com_avg THEN 'same' 
        END AS 'comparison'
FROM
    (
        SELECT 
